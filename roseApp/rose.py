...
# from roseApp.cli.diagnose import app as diagnose_app  # Temporarily disabled due to API migration
...
# app.add_typer(diagnose_app)  # Temporarily disabled due to API migration
